...
- **Self-failure issue keeps reopening**: a setup precondition is still broken (gh login, claude login, repo path). Fix the precondition; the next tick will close it automatically when conditions hold.
