import { User, Shield, EyeOff, Trash2, Award } from 'lucide-react'
...
export function ContactCard({ contact, onHide, onRemove, attestationCount = 0 }: ContactCardProps) {
  const statusColors = {
  ...
  return (
    <div className="bg-white rounded-lg border border-slate-200 p-4">
      <div className="flex items-start gap-3">
        ...
        {contact.status === 'hidden' && onRemove && (
          <button
            onClick={onRemove}
