...
`wot-hmc@0.1` | `wot-spec/05-hmc-extensions/` | `packages/wot-core/src/protocol/trust/sd-jwt-vc.ts`, `packages/wot-core/src/protocol/hmc/trust-list-delta.ts`; authority and forwarding semantics remain tracked in `real-life-org/wot-spec#43`.
