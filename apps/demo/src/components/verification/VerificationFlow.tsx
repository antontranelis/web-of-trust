    ...
    return (
      <div className="space-y-6">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-stone-900">{t.verification.title}</h2>
        ...
        {!isScanning && (
          <>
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-stone-400">{t.common.or}</span>
              <div className="flex-1 h-px bg-stone-200" />
            </div>
  ...
  if (mode === 'success') {
    return (
      <div className="text-center py-8">
          ...
          <h3 className="text-xl font-bold text-stone-900 mb-2">{t.verification.successTitle}</h3>
  ...
  if (mode === 'error') {
    return (
      <div className="text-center py-8">
        ...
        <h3 className="text-xl font-bold text-stone-900 mb-2">{t.verification.errorTitle}</h3>
        <p className="text-stone-600 mb-6">
