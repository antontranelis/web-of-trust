    ...
    <span className="relative inline-flex">
      ...
      {open && (
        <div
          ...
          className="z-50 w-64 px-3 py-2 bg-foreground text-white text-xs rounded-lg shadow-lg animate-fade-in"
        >
          {content}
          <div
            className="absolute -top-1 w-2 h-2 bg-foreground rotate-45"
